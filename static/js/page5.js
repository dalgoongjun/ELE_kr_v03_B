...
const problems = [
    {
      image: './static/images/unit03/sawing.svg',
      question: '헤지거나 뚫어진 데를 바늘로 깁거나 얽어매다.',
      answers: ['꿰매다', '빻다', '재배하다', '짓다'],
      correct: 0,
    },
    {
      image: './static/images/unit03/harvest.svg',
      question: '식물을 심어 가꾸다.',
      answers: ['꿰매다', '빻다', '재배하다', '짓다'],
      correct: 2,
    },
    {
      image: './static/images/unit03/grind.svg',
      question: '물기가 없는 것을 짓찧어서 가루로 만들다.',
      answers: ['꿰매다', '빻다', '재배하다', '짓다'],
      correct: 1,
    },
    {
      image: './static/images/unit03/make.svg',
      question: '재료를 들여 밥, 옷, 집 따위를 만들다.',
      answers: ['꿰매다', '빻다', '재배하다', '짓다'],
      correct: 3,
    },
  ];
